...
namespace EntityModelPOC.Controls
{
    public class ExtendedRepeatButton : RepeatButton
    {
        ...
        public static readonly DependencyProperty DisabledBackgroundColorProperty =
            DependencyProperty.Register("DisabledBackgroundColor", typeof(Brush), typeof(ExtendedRepeatButton), new UIPropertyMetadata(null));
        ...
        public static readonly DependencyProperty HoverBackgroundColorProperty =
            DependencyProperty.Register("HoverBackgroundColor", typeof(Brush), typeof(ExtendedRepeatButton), new UIPropertyMetadata(null));
        ...
        public static readonly DependencyProperty NormalBackgroundColorProperty =
            DependencyProperty.Register("NormalBackgroundColor", typeof(Brush), typeof(ExtendedRepeatButton), new UIPropertyMetadata(null));
